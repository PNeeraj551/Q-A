              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-xs text-slate-500 hover:text-indigo-600 transition-colors duration-150 select-none"
                  >
                    Posting as:
                ...
                {/* Row 2: Input + Send */}
                <div className="flex items-end gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-500/10 transition-all duration-200">
                  <textarea
                    ref={composerRef}
                    rows={1}
                    ...
                    maxLength={5000}
                    className="flex-1 min-w-0 resize-none bg-transparent border-0 outline-none text-sm leading-6 text-slate-800 placeholder:text-slate-400 overflow-y-auto"
                    style={{ maxHeight: '40vh' }}
                  />
                  <button
                    type="submit"
                    disabled={!questionText.trim()}
                    className="shrink-0 w-8 h-8 rounded-lg flex items-center justify-center bg-gradient-to-br from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-150 shadow-sm active:scale-95"
                  >
